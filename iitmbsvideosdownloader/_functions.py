...
from iitmbsvideosdownloader._variables import DEBUG, VERBOSE


def check_argumnets(browser_path: str, download_path: str, user_data_path: str, profile_name: str, subjects: list, year: int, term: int, week: int, sleep_time: int = 2, debug : bool = True, verbose: int = 2):
    ...
    if term not in [1, 2, 3]:
        raise Exception("term should be an integer between 1 to 3, for ex: 1 for Jan Term, 2 for May Term, 3 for Sep Term")
